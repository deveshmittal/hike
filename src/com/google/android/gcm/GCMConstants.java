...
public final class GCMConstants {
    public static String INTENT_PACKAGE = "com.nokia.pushnotifications";
    public static String SERVICE_PACKAGE = "com.nokia.pushnotifications.service";
    public static String PREFERENCES = "com.nokia.pushnotifications.helper.preferences";
    
    /**
     * Intent sent to GCM to register the application.
     */
    public static final String INTENT_TO_GCM_REGISTRATION() { return INTENT_PACKAGE + ".intent.REGISTER"; }

    /**
     * Intent sent to GCM to unregister the application.
     */
    public static final String INTENT_TO_GCM_UNREGISTRATION() { return INTENT_PACKAGE + ".intent.UNREGISTER"; }

    /**
     * Intent sent by GCM indicating with the result of a registration request.
     */
    public static final String INTENT_FROM_GCM_REGISTRATION_CALLBACK() { return INTENT_PACKAGE + ".intent.REGISTRATION"; }
     ...
     */
    public static final String INTENT_FROM_GCM_MESSAGE() { return INTENT_PACKAGE + ".intent.RECEIVE"; }
     ...
     * Extra used on
     * {@value com.google.android.gcm.GCMConstants#INTENT_FROM_GCM_REGISTRATION_CALLBACK}
     * to indicate an error when the registration fails. See constants starting
     * with ERROR_ for possible values.
     */
     ...
     * intent. This extra is only set for special messages sent from GCM, not
     * for messages originated from the application.
     */
    ...
    /**
     * Extra used on
     * {@value com.google.android.gcm.GCMConstants#INTENT_FROM_GCM_MESSAGE} to
     * indicate which sender (Google API project id) sent the message.
     */
     ...
     */
    public static final String PERMISSION_GCM_INTENTS() { return INTENT_PACKAGE + ".permission.SEND"; }
