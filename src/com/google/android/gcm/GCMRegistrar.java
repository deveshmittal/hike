...
public final class GCMRegistrar {
    ...
    public static void checkDevice(Context context) {
        ...
        try {
            packageManager.getPackageInfo(GCMConstants.SERVICE_PACKAGE, 0);
        } catch (NameNotFoundException e) {
            //throw new UnsupportedOperationException(
            //        "Device does not have package " + GCMConstants.SERVICE_PACKAGE);
        }
    }
    ...
    static void internalRegister(Context context, String... senderIds) {
        ...
        intent.setPackage(GCMConstants.SERVICE_PACKAGE);
    ...
    private static SharedPreferences getGCMPreferences(Context context) {
        return context.getSharedPreferences(GCMConstants.PREFERENCES, Context.MODE_PRIVATE);
    }
