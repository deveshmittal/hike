...
public abstract class ProfileItem {
	...
	static public class ProfileLinkItem extends ProfileItem {
		...
		public void bindView(Context context, View v) {
			...
			ProfileViewHolder holder = (ProfileViewHolder) v
					.getTag(R.id.profile_item_extra);
	...
	/**
	 * The intent to launch when this item is selected. Return null if you don't
	 * want this item to be selectable
	 * 
	...
	public void bindView(Context context, View v) {
		ProfileViewHolder holder = (ProfileViewHolder) v
				.getTag(R.id.profile_item_extra);
		holder.iconView.setImageDrawable(context.getResources().getDrawable(
				getIcon()));
