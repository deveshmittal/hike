...
public class GroupTypingNotification extends TypingNotification {
	...
	public GroupTypingNotification(String id, String participant,
			ClearGroupTypingNotification clearGroupTypingNotification) {
		super(id);
	...
	public void addClearTypingNotification(
			ClearGroupTypingNotification clearGroupTypingNotification) {
		clearGroupTypingNotificationList.add(clearGroupTypingNotification);
	}

	public ClearGroupTypingNotification getClearTypingNotification(
			String participant) {
		for (ClearGroupTypingNotification clearGroupTypingNotification : clearGroupTypingNotificationList) {
			if (clearGroupTypingNotification.getParticipantMsisdn().equals(
					participant)) {
