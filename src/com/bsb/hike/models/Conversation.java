...
public class Conversation implements Comparable<Conversation> {
	...
	public static class ConversationComparator implements
	...
	public String toString() {
		return "Conversation [msisdn=" + msisdn + ", convId=" + convId
				+ ", messages=" + messages.size() + ", contactName="
				+ contactName + ", onhike=" + onhike + "]";
	}
	...
	/*
	 * Returns a friendly name for this conversation (name if non-empty,
	 * otherwise msisdn)
	 */
	...
	public Conversation(String msisdn, long convId, String contactName,
			boolean onhike) {
		this.msisdn = msisdn;
		this.convId = convId;
	...
	public int compareTo(Conversation rhs) {
		...
		long ts = messages.isEmpty() ? 0 : messages.get(messages.size() - 1)
				.getTimestamp();
		if (rhs == null) {
			return 1;
		}

		long rhsTs = rhs.messages.isEmpty() ? 0 : rhs.messages.get(
				rhs.messages.size() - 1).getTimestamp();
