...
public class ProfilePicImageLoader extends ImageWorker
{
	...
	protected Bitmap processBitmap(String id)
	{
		...
		boolean hasCustomImage = HikeUserDatabase.getInstance().hasIcon(idd);

		String fileName = hasCustomImage ? Utils.getProfileImageFileName(idd) : Utils.getDefaultAvatarServerName(idd);
