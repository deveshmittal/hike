...
public class SmileyParser
{
	...
	private final String[] mEmojiUnicodes = {
			"\uD83D\uDE04",
			"\uD83D\uDE0A",
			"\uD83D\uDE03",
			"\u263A",
	...
	private HashMap<String, Integer> buildSmileyToRes()
	{
		...
		if (EMOJI_RES_IDS.length != mEmojiUnicodes.length)
		{
		...
		for (int i = 0; i<mEmojiUnicodes.length; i++)
		{
			smileyToRes.put(mEmojiUnicodes[i], EMOJI_RES_IDS[i]);
		}
