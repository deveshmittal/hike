...
public class AccountUtils {
	...
	public static final String GAMES_PRODUCTION_BASE = "hike.in/rewards/android/";

	public static final String GAMES_STAGING_BASE = "staging.im.hike.in/rewards/android/";
