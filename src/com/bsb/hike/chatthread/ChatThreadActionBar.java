...
public class ChatThreadActionBar {

	private ChatThreadActivity activity;
	...
	public ChatThreadActionBar(ChatThreadActivity activity) {
	...
	public void onCreateOptionsMenu(Menu menu, int menuLayout,
			List<OverFlowMenuItem> overflowItems,
			OverflowItemClickListener listener) {
		onCreateOptionsMenu(menu, menuLayout);
		onCreateOverflowMenu(overflowItems, listener);
	}

	private void onCreateOverflowMenu(List<OverFlowMenuItem> overflowItems,
			OverflowItemClickListener listener) {
		overFlowMenuLayout = new OverFlowMenuLayout(overflowItems, listener,
				activity);
	}
	...
	/**
	 * If something is your activity specific then handle that click on your
	 * side pass click if it is some sort of utility OR common case which this
	 * object can handle for example copy
	 * 
	 * @param menuItem
	 */
	...
	public void setOverFlowMenuItems(Set<OverFlowMenuItem> parameter,
			OverflowItemClickListener parameter2) {
		// TODO implement me
	}
