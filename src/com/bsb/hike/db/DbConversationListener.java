...
public class DbConversationListener implements Listener
{
	...
	public void onEventReceived(String type, Object object)
	{
		...
		else if (HikePubSub.SEND_NATIVE_SMS_FALLBACK.equals(type))
		{
			...
			ContactInfo c = ContactManager.getInstance().getContact(messages.get(0).getMsisdn(), true, true);
			sendNativeSMSFallbackLogEvent(c.isOnhike(), Utils.isUserOnline(context), messages.size());
