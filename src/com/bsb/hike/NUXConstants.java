...
public class NUXConstants
{
	...
	public static final String INVITEFRDS_IMAGE = "im";
	...
	public static final String TD_INCENTIVE_ID = "incentiveid";

	public static final String TD_ACTIVITY_ID = "activityid";
