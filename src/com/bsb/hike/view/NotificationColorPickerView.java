...
public class NotificationColorPickerView extends View
{
	    ...
	    public NotificationColorPickerView(Context context) {
	        super(context);
	        init(null, 0);
	    }

	    public NotificationColorPickerView(Context context, AttributeSet attrs) {
	        super(context, attrs);
	        init(attrs, 0);
	    }

	    public NotificationColorPickerView(Context context, AttributeSet attrs, int defStyle) {
	    ...
	    private void init(AttributeSet attrs, int defStyle) {
	        mColorWheelThickness = Utils.dp(8);
	        ...
	        mColorCenterHaloRadius = Utils.dp(60);
	        mPreferredColorCenterHaloRadius = mColorCenterHaloRadius;
	        mColorPointerRadius = Utils.dp(14);
	        mColorPointerHaloRadius = Utils.dp(18);
	    ...
	    /**
	     * This API sets new selected color to right half of center circle
	     * @param color
	     */
	    ...
	    /**
	     * This API sets previous selected color to left half of center circle
	     * @param color
	     */
