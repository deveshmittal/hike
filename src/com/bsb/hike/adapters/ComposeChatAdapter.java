...
public class ComposeChatAdapter extends FriendsAdapter implements PinnedSectionListAdapter
{
	...
	public ComposeChatAdapter(Context context, ListView listView, boolean fetchGroups, boolean fetchRecents, boolean showDefaultEmptyList, String existingGroupId, String sendingMsisdn, FriendsListFetchedCallback friendsListFetchedCallback)
	{
	...
	public void executeFetchTask()
	{
		...
		FetchFriendsTask fetchFriendsTask = new FetchFriendsTask(this, context, friendsList, hikeContactsList, smsContactsList, recentContactsList, friendsStealthList, hikeStealthContactsList,
				...
				existingParticipants, sendingMsisdn, fetchGroups, existingGroupId, isCreatingOrEditingGroup, true, false, fetchRecents, showDefaultEmptyList);
