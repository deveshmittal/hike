...
public class HikeNotification
{
	...
	{
		showNotification(notificationIntent, icon, timestamp, notificationId, text, key, message, msisdn, bigPictureImage, false, isPin, false, null, null, forceNotPlaySound);
	}
