...
public class ConversationFragment extends SherlockListFragment implements OnItemLongClickListener, Listener, OnScrollListener
{
	...
	private void setupEmptyView()
	{
		...
		{
			EmptyConversationItem hikeContactsItem = new EmptyConversationItem(HomeActivity.ftueContactsData.getSmsContacts(), getResources().getString(R.string.ftue_sms_contact_card_header, 0), EmptyConversationItem.SMS_CONTACTS);
			ftueListItems.add(hikeContactsItem);
		}
