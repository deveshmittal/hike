...
public class HomeActivity extends HikeAppStateBaseFragmentActivity implements Listener
{
	...
	private void showAppropriateDialog()
	{
		...
		case STEALTH_FTUE_POPUP:
			...
			dialog = HikeDialogFactory.showDialog(this, HikeDialogFactory.STEALTH_FTUE_DIALOG, getHomeActivityDialogListener());
			break;
		case STEALTH_FTUE_EMPTY_STATE_POPUP:
			dialogShowing = DialogShowing.STEALTH_FTUE_EMPTY_STATE_POPUP;
			dialog = HikeDialogFactory.showDialog(this, HikeDialogFactory.STEALTH_FTUE_EMPTY_STATE_DIALOG, getHomeActivityDialogListener());
			break;
		}
	}
