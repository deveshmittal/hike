...
public class HomeActivity extends HikeAppStateBaseFragmentActivity implements Listener
{
	...
	protected void onResume()
	{
		...
		HikeAlarmManager.cancelAlarm(HomeActivity.this, HikeAlarmManager.REQUESTCODE_RETRY_LOCAL_NOTIFICATION);
			...
			public void onItemClick(AdapterView<?> adapterView, View view, int position, long id)
			{
				...
				case 7:
					try
					{
						...
						HAManager.getInstance(getApplicationContext()).record(AnalyticsConstants.UI_EVENT, AnalyticsConstants.CLICK_EVENT, md);
					}
					catch(JSONException e)
					{
						Logger.d(AnalyticsConstants.ANALYTICS_TAG, "invalid json");
