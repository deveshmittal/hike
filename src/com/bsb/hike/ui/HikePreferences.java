	...
	public boolean onPreferenceChange(Preference preference, Object newValue)
	{
		...
		else if (HikeConstants.PROFILE_PIC_PREF.equals(preference.getKey()))
		{
			...
			if (isChecked) {
				...
				try {
					metadata.put(HikeConstants.EVENT_KEY,HikeConstants.LogEvent.SETTINGS_ENTER_ON);
				} catch (JSONException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				...
				try {
					metadata.put(HikeConstants.EVENT_KEY,HikeConstants.LogEvent.SETTINGS_ENTER_OFF);
				} catch (JSONException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
