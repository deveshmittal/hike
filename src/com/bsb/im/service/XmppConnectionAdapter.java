...
import com.bsb.im.smack.avatar.AvatarListener;
import com.bsb.im.smack.avatar.AvatarMetadataExtension;
import com.bsb.im.smack.pep.PepSubManager;
import com.bsb.im.ui.ChangeStatus;
import com.bsb.im.ui.Subscription;
...
public class XmppConnectionAdapter extends IXmppConnection.Stub {
	...
	mResource = mPref.getString(BeemApplication.CONNECTION_RESOURCE_KEY, "im");
    }
	...
	if (mAdaptee.isConnected())
		...
		try {
			...
			mService.getResources().getIdentifier(
			    e.getMessage(), "string", "com.bsb.im"));
		    mErrorMsg = str;
	...
	try {
	    ...
	    mAdaptee.login(mLogin, mPassword, mResource,"1",BeemApplication.apid);//"AndroidAPID");//BeemApplication.apid);
	...
	mStatusNotification = new Notification(com.bsb.im.R.drawable.beem_status_icon, text, System
	    .currentTimeMillis());
	...
	mStatusNotification.setLatestEventInfo(mService, "Im Status", text, PendingIntent.getActivity(mService, 0,
	...
	ServiceDiscoveryManager.setIdentityName("im");
