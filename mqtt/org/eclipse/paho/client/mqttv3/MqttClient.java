...
{ // ), DestinationProvider {
	 ...
	 */
	public MqttClient(String serverURI, String clientId, int maxInflightMsgs) throws MqttException
	{
	 ...
	 *             if any other problem was encountered
	 */
	public MqttClient(String serverURI, String clientId, MqttClientPersistence persistence, int maxInflightMsgs) throws MqttException
	{
		aClient = new MqttAsyncClient(serverURI, clientId, persistence, maxInflightMsgs);
	}
